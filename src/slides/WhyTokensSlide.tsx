    ...
    <SlideContainer>
      <div className="flex flex-col items-center gap-6 max-w-3xl">
        ...
        <div className="w-full flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4">
            <div className="w-32 text-right">
              <p className="text-base text-foreground-200">All tools in context</p>
            </div>
            <div className="flex-1 h-8 rounded-lg border border-compute-100/30 relative overflow-hidden">
              ...
              />
              <span className="absolute right-3 top-1/2 -translate-y-1/2 text-base font-mono font-medium text-compute-100 z-10">
                1.17M tokens
              </span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            <div className="w-32 text-right">
              <p className="text-base text-foreground-200">Code Mode</p>
            </div>
            <div className="flex items-center gap-3 flex-1">
              ...
              <motion.span
                className="rounded-full border border-accent-100/30 bg-accent-100/10 px-3 py-0.5 text-base font-medium text-accent-100"
        ...
        <div className="w-full rounded-lg border border-border-100 bg-background-200 p-5">
          <p className="text-base font-medium text-foreground-200 mb-3">
            The model gets 2 tools:
          </p>
          <div className="flex gap-4">
            <div className="flex-1 rounded-lg border border-compute-100/30 bg-compute-100/5 p-3">
              <p className="font-mono text-base text-compute-100 font-medium">search()</p>
              <p className="text-base text-foreground-200 mt-1">
                Discovers relevant tools by keyword. Only loads what's needed.
              </p>
              <p className="text-base text-foreground-200/50 mt-2">
        ...
        <div className="rounded-lg border border-accent-100 bg-accent-100/10 px-6 py-4 w-full">
          <p className="text-base text-foreground-100 text-center leading-relaxed italic">
