/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 11fc973e2fa898d78dd2a143e90934ea)
// Runtime types generated with workerd@1.20260301.1 2026-01-28 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "CodemodeTalk" | "Sandbox" | "CloudflareAPIAgent";
	}
	interface Env {
		LOADER: WorkerLoader;
		AI: Ai;
		...
		CloudflareAPIAgent: DurableObjectNamespace<import("./src/server").CloudflareAPIAgent>;
	}
}
